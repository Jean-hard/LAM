...
public class EnqèteManager : MonoBehaviour
{
    ...
    private List<GameObject> imagetodragrandomized = new List<GameObject>();//les images qu'il faut drag mélangé 
    ...
    void Start()
    {
        ...
        for (int i = 0; i <= 7; i++)//pour toutes les pièces 
        {
            ...
            if (nbrdecare == 4)//si y a deja 4 pièce sur la colomne 
            {
